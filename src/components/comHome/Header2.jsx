      ...
      <div className="relative flex justify-end max-w-xl mx-auto xl:pr-32 lg:max-w-screen-xl">
        <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
          <div className="max-w-xl mb-6 md:mx-9">
            ...
            A wide range of car agencies in one place. 
            With the latest specifications and prices of cars, 
            according to continuous updating to ensure the accuracy of the data.
            </p>
          </div>
        </div>
      </div>
