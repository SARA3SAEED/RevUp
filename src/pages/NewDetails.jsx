    ...
    return (
        <div className="h-screen">
            <div className=" flex flex-col h-full justify-between">
                <div className="flex-none ">{isLoggedIn ? <NavLog role={userRole} /> : <Nav />}</div>
                <div className="flex flex-col  items-center flex-1 h-full bg-slate-200">
                    {isOpen ? tabIndex == 9 ? <>
                        <div className={` flex justify-around items-center bg-opacity-10 w-2/5 h-[4.5rem] rounded-b-xl  `}>
                            <button className="w-16 h-16 bg-center bg-cover" style={{ backgroundImage: `url(${rimdefult})` }} onClick={() => {
                    ...
                    >
                        ...
                        <div className="w-14 h-14  rounded-full shadow-md bg-center bg-cover" style={{ backgroundImage: `url(${Colorwheel})` }} >
                            ...
                            <input
                                ...
                                type="color" className="w-14 h-14 appearance-none opacity-0" />
                        </div>
                    ...
                    <div className="flex flex-1 w-full h-full">
                        <div className="p-2 flex flex-1 w-full h-full"><CameraSetting /></div>
                            ...
                            <ul className="menu max-sm:menu-horizontal bg-base-200 gap-4 max-sm:w-full rounded-box">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <div className="">
                                            <ul tabIndex={0} className="dropdown-content menu bg-base-200 rounded-box z-[1] w-fit p-2 shadow">
                                                <li><button data-tip="Rim Color" className="tooltip tooltip-left" onClick={() => {
                                                    setTabIndex(2);
                                                    setIsOpen(true);
                                                    setBgColor('#E2E8F0');
                                                    cameraSetter(2);
                                                ...
                                                <li>
                                                    <button data-tip="Rim Type" className="tooltip tooltip-left" onClick={() => {
                                                        setTabIndex(9);
                                                        setIsOpen(true);
                                                        setBgColor('#E2E8F0');
                                                        cameraSetter(2);
